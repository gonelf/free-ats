...
export default function UpgradePage() {
  ...
  return (
    <div>
      ...
      <div className="rounded-2xl border-2 border-indigo-600 bg-white dark:bg-gray-900 p-8 shadow-xl mb-6">
        <div className="flex items-baseline justify-between mb-6">
          <div>
            <span className="text-4xl font-bold text-gray-900 dark:text-gray-100">$49</span>
            <span className="text-gray-500 dark:text-gray-400 ml-2">/ month per workspace</span>
          </div>
          <span className="rounded-full bg-indigo-100 dark:bg-indigo-900/40 px-3 py-1 text-sm font-medium text-indigo-700 dark:text-indigo-400">
          ...
          {features.map((feature, i) => {
            ...
            return (
              <li key={i} className="flex items-center gap-3">
                <div className="flex h-5 w-5 items-center justify-center rounded-full bg-indigo-100 dark:bg-indigo-900/40">
