    ...
    <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-6 space-y-5">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-xs text-white/50">Headcount</span>
          <span className="text-lg font-bold text-white">{headcount}</span>
        </div>
        <input
          type="range"
          min={1}
      ...
      {/* Result */}
      <div className="rounded-xl bg-emerald-500/10 border border-emerald-500/20 px-5 py-4 text-center">
        <p className="text-xs text-white/40 mb-1">Annual savings with remote team</p>
      ...
      <Link
        href="/signup"
        className="flex items-center justify-center gap-2 w-full rounded-xl bg-emerald-500 px-5 py-3 text-sm font-semibold text-[#080c10] hover:bg-emerald-400 transition-colors shadow-lg shadow-emerald-500/20"
      >
